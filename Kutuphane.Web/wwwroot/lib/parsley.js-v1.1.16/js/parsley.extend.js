...
(function ($) {
  window.ParsleyConfig = $.extend( true, {}, window.ParsleyConfig, {
    ...
    , messages: {
        minwords:       "En az %s karakter olmalıdır."
      , maxwords:       "En fazla %s karakter olmalıdır."
      , rangewords:     "%s ile %s karakter arasında olmalıdır."
      , greaterthan:    "%s değerinden büyük olmalıdır."
